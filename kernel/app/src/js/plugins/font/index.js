...
class Font extends Base {
    ...
    async before() {
        ...
        this.setFontSize(
            ...
            this.context.siyuan.config.editor.fontFamily,
            this.context.siyuan.config.editor.codeLigatures,
        );
    }
    ...
    setFontSize(fontSize, fontFamily, codeLigatures) {
        let style = this.context.document.getElementById('editorFontSize');
        if (style) {
